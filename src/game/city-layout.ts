/**
 * Garden-city layout. Terrain cells share terrain kinds and road masks
 * with the terrain baker and city buildings.
 */
import {
  ROAD_EAST,
  ROAD_NORTH,
  ...
  type TerrainCell,
  type TerrainGrid,
} from "@/game/isometric/layouts/terrain";
import { hashCoords, pick, chance, pickIndex } from "@/game/isometric/math/hash";
