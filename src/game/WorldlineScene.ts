...
import { createBaker, TILE_ANCHOR_Y, TILE_HEIGHT, TILE_WIDTH } from "@/game/isometric/textures/core";
import { bakeCityBuilding } from "@/game/city-buildings";
import {
  HIGHLIGHT_KEY,
  SELECT_KEY,
  bakeHighlight,
} from "@/game/isometric/textures/effects";
import { createIsoProjection } from "@/game/isometric/math/iso";
import {
  TERRAIN_ATLAS_KEY,
  bakeTerrainAtlas,
  roadTextureKey,
...
} from "@/game/isometric/textures/terrain";
import {
  bakeBush,
  bakeFountain,
  bakeLamp,
  ...
  bakeTree,
  propTextureKey,
} from "@/game/isometric/textures/props";
import type { TerrainCell } from "@/game/isometric/layouts/terrain";
import {
  buildCityLayout,
  CAPITOL_X,
  CAPITOL_Y,
